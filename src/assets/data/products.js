import productImg01 from "../images/double-sofa-01.jpg";
...
const products = [
  {
    ...
    description:
      "Experience luxury and comfort with the Stone and Beam Westview sofa. This sofa is crafted with precision, featuring a durable frame and plush cushions for the perfect lounging experience. The modern design adds a touch of sophistication to any living space. Enjoy quality time with family and friends on this exquisite piece of furniture.",
    reviews: [
      {
        rating: 4.7,
...

  {
    ...
    description:
      "Add a touch of elegance to your home with the Amazon Brand Modern Sofa. This affordable yet luxurious sofa is designed to provide comfort and style. The durable construction ensures long-lasting use, and the modern aesthetic complements any decor. Make your living room a welcoming haven with this Amazon Brand sofa.",
    reviews: [
      {
        rating: 4.6,
        text: "The Amazon Brand Modern Sofa is a great value for money. It's comfortable, sturdy, and looks much more expensive than it is.",
      },
      {
        rating: 4.9,
        text: "I was pleasantly surprised by the quality of the Amazon Brand Modern Sofa. It's a fantastic addition to my living room.",
      },
    ],
    avgRating: 4.7,
  },
...

  {
    ...
    description:
      "Indulge in comfort with the Fllufy Sheep Sofa. This sofa is designed for relaxation, featuring a soft and plush feel that invites you to unwind. The unique sheep-inspired design adds a whimsical touch to your living space. Upgrade your home with the Fllufy Sheep Sofa and enjoy the luxury of coziness.",
    reviews: [
      {
        rating: 4.6,
        text: "The Fllufy Sheep Sofa is incredibly comfortable. It's like sitting on a cloud. I love the unique design as well.",
      },
      {
        rating: 4.9,
        text: "This sofa exceeded my expectations. The Fllufy Sheep Sofa not only looks adorable but is also one of the comfiest sofas I've ever had.",
      },
    ],
    avgRating: 4.7,
  },

  {
    ...
    description:
      "Upgrade your home decor with the Faux Velvet Sofa. This elegant sofa features a faux velvet upholstery that adds a touch of luxury to your living space. The sturdy construction ensures durability, while the plush cushions provide a comfortable seating experience. Make a statement in your home with the Faux Velvet Sofa.",
    reviews: [
      {
        rating: 4.7,
        text: "I am in love with the Faux Velvet Sofa. It's not only stylish but also surprisingly comfortable. The velvet fabric adds a luxurious feel.",
      },
      {
        rating: 4.8,
        text: "The Faux Velvet Sofa exceeded my expectations. It's a beautiful addition to my living room, and the comfort level is unmatched.",
      },
    ],
    avgRating: 4.8,
  },
...

  {
    ...
    description:
      "Indulge in the ultimate comfort with the Leather Recliner. This sofa combines the luxurious feel of leather with the convenience of a reclining feature. The sturdy construction ensures durability, and the plush cushions provide a comfortable seating experience. Upgrade your living space with the elegance and functionality of the Leather Recliner.",
    reviews: [
      {
        rating: 4.9,
        text: "The Leather Recliner is a game-changer in my living room. It's not only stylish but also incredibly comfortable. The reclining feature is a bonus.",
      },
      {
        rating: 4.8,
        text: "I couldn't be happier with my purchase of the Leather Recliner. It's a high-quality piece of furniture that adds a touch of luxury to my home.",
      },
    ],
    avgRating: 4.9,
  },

  {
    ...
    description:
      "Unwind in style with the Velvet Chaise Lounge. This elegant piece of furniture is designed for both comfort and luxury. The velvet upholstery adds a touch of opulence to your living space, while the chaise design allows you to stretch out and relax. Elevate your home decor with the sophistication of the Velvet Chaise Lounge.",
    reviews: [
      {
        rating: 4.8,
        text: "The Velvet Chaise Lounge is a showstopper in my living room. It's not only comfortable but also adds a touch of glamour to the space.",
      },
      {
        rating: 4.7,
        text: "I love the luxurious feel of the Velvet Chaise Lounge. It's a perfect spot for relaxation, and the quality is exceptional.",
      },
    ],
    avgRating: 4.8,
  },
